<h1 align="center">Ecos do Sur App</h1>
...
*Aínda estamos a compilar. E a testear. E a compilar outra vez.
Pero xa case: **proximamente na Play Store**.*
...
- **Accesibilidade:** dereito fundamental que asegura a igualdade de participación na sociedade para as persoas en condicións adversas.
- **Empoderamento:** canle segura e discreta para acceder a información, recursos e acompañamento ás vítimas de racismo e xenofobia.
- **Loita contra a desinformación:** fronte aos LLMs que poden transmitir información sesgada ou incorrecta, a app garante información verificada e controlada pola ONG.

### Tecnolóxicas

- **Tecnoloxías abertas:** ferramentas libres e multiplataforma (React Native, Elixir, Expo) que promoven a independencia tecnolóxica e a colaboración comunitaria.
- **Reutilización e innovación:** a expansión do chatbot existente de Telegram garante continuidade e aproveitamento de recursos.
- **Escalabilidade e mantemento:** backend en Elixir (alta concorrencia) e frontend en React Native (multiplataforma), permitindo crecemento futuro.
...
- **Información de utilidade**: discurso de odio nas redes sociais, recursos de sanidade, información por comunidade autónoma e directorio de comercios e servizos
...
- **Permitir rexistrar usuarios** que poden gardar os seus datos persoais como historial de chats, idioma e preferencias
- **Internacionalización da aplicación** con soporte para Español, Galego e Inglés, coa posibilidade de engadir máis idiomas
- **Asegurar un deseño responsivo, accesible e personalizable** con modo claro/oscuro
- **Implementar autenticación segura** con tokens JWT e protección de endpoints
...
Backend (Elixir/ExUnit): tests de integración HTTP, autenticación, validación de datos, páxinación e casos límite. Frontend (Jest/React Testing Library): compoñentes, navegación e integración con API.
...
```bash
# Build local (rápido, sen conta EAS)
cd frontend
...
eas login
eas build --platform android --profile development   # APK de desenvolvemento
...
- **React DevTools** / **Expo DevTools** - Depuración de compoñentes, logs e estado
...
- Protección contra inxección SQL/NoSQL
...
A aplicación soporta Español (es), Inglés (en) e Galego (gl/gal). Os usuarios poden cambiar o idioma dende a configuración da app. As traducións están en `frontend/app/i18n/`.
