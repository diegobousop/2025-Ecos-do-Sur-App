...
export type TimeRange = '7days' | '30days' | '365days';

interface AnalyticsPageProps {
  preloadedStats?: ConversationStats | null;
  preloading?: boolean;
  timeRange?: TimeRange;
...
const AnalyticsPage = ({ 
  ...
  const timeRange = externalTimeRange || '365days';
    ...
    >
      <View className="p-4 gap-6">
        ...
        <View className="flex-row gap-2 justify-center">
          <TouchableOpacity
            onPress={() => handleTimeRangeChange('7days')}
          ...
          <TouchableOpacity
            onPress={() => handleTimeRangeChange('30days')}
            className={`px-4 py-2 rounded-full ${
              timeRange === '30days' 
                ? 'bg-blue-500' 
                : 'bg-gray-200 dark:bg-gray-700'
          ...
          <TouchableOpacity
            onPress={() => handleTimeRangeChange('365days')}
            className={`px-4 py-2 rounded-full ${
              timeRange === '365days' 
                ? 'bg-blue-500' 
                : 'bg-gray-200 dark:bg-gray-700'
